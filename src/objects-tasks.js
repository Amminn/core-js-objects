...
function mergeObjects(objects) {
  ...
  objects.forEach((element) => {
    Object.entries(element).forEach(([key, value]) => {
      result[key] = result[key] === undefined ? value : result[key] + value;
    });
  });
...
class CssSelector {
  ...
  element(value) {
    ...
    newSelector.selector = { ...this.selector, element: value };
    newSelector.lastOrder = this.lastOrder;
    return newSelector;
  }
  ...
  id(value) {
    ...
    const newSelector = new CssSelector();
    newSelector.selector = { ...this.selector, id: `#${value}` };
    newSelector.lastOrder = this.lastOrder;
    return newSelector;
  }
  ...
  pseudoElement(value) {
    ...
    const newSelector = new CssSelector();
    newSelector.selector = { ...this.selector, pseudoElement: `::${value}` };
    newSelector.lastOrder = this.lastOrder;
    return newSelector;
  }
